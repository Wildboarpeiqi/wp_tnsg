...
<section class="page-banner" style="background-image:url('<?php echo esc_url($project_banner); ?>');">
  <div class="page-banner-inner">
    <div class="page-banner-title"><?php echo esc_html(jc_g62('project_banner_title', jc_t('PROJECTS'))); ?></div>
    <div class="breadcrumb">
      <a href="<?php echo esc_url(jc_home_url()); ?>"><?php echo esc_html(jc_t('HOME')); ?></a> &gt;
      <a href="<?php echo esc_url(get_post_type_archive_link('project')); ?>"><?php echo esc_html(jc_g62('project_banner_title', jc_t('PROJECTS'))); ?></a> &gt;
...
<div class="container page-wrap">
  ...
  <main class="page-main">
    ...
    <article class="article" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
      ...
      <nav class="article-nav" aria-label="<?php echo esc_attr(jc_t('Project navigation')); ?>">
        <?php if ($prev_post) : ?>
