...
<section class="page-banner" style="background-image:url('<?php echo esc_url($faq_banner); ?>');">
  <div class="page-banner-inner">
    <div class="page-banner-title"><?php echo esc_html(jc_g62('faq_banner_title', jc_t('FAQ'))); ?></div>
    <div class="breadcrumb">
      <a href="<?php echo esc_url(jc_home_url()); ?>"><?php echo esc_html(jc_t('HOME')); ?></a> &gt;
      <a href="<?php echo esc_url(get_post_type_archive_link('faq')); ?>"><?php echo esc_html(jc_t('FAQ')); ?></a> &gt;
...
<div class="container page-wrap">
  ...
  <main class="page-main">
    ...
    <article class="article" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
      ...
      <!-- 发布时间（强制英文格式，与 single-post.php 一致） 改了，没用了-->
      ...
      <nav class="article-nav" aria-label="<?php echo esc_attr(jc_t('FAQ navigation')); ?>">
        <?php if ($prev_post) : ?>
